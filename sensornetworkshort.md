...
- utilizzando un **gateway applicativo** per **compattare** o **tradurre** i messaggi:
     ...
     - la **traduzione del livello applicativo** (L7 pila OSI), quella che definisce il tipo si protocollo Client/Server End to End e il tipo di semantica applicativa, stavolta e necessaria e deve per forza avvenire sul gateway di confine tra la rete di sensori e la rete di distribuzione.
