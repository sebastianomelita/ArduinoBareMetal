...
Le reti di sensori sono costituite da dispositivi HW a basso costo che spesso implementano i primi due livelli della pila ISO/OSI, che sono diver. SOpra di essi si può aggiungere il resto dello stack

Una rete di sensori, intesa in senso largo come reti di sensori di dati ambiantali, sensori di comando (ad es. pulsanti) ed attuazioni di dispositivi sul campo (ad es. luci o motori) potrebbe comprendere dispositivi di tecnologie diverse o, se di ugual tecnologia, fornite da produttori diversi. Per ottenere la realizzazione di un **sistema aperto** le sfide sono essenzialmente due:
