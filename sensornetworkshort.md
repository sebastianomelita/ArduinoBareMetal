...
Ma anche questa ultima possibilità è soltanto teorica perchè le reti di sensori spesso hanno limiti molto stringenti sulla dimensioni dei dati che possono trasportare, per cui è necessario un livello di **traduzione** delle informazioni da un formato testuale autoesplicativo ad uno binario molto compatto ma codificato ad hoc. Nascono cioè problemi a causa di una diversa possibilità che hanno le varie reti di sensori di implementare il **livello di presentazione** della pila ISO/OSI (L6).
