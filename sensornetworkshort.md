...
- **nodo sensore di rete**. Dispositivo che in un unico **contenitore** ingloba **insieme** un certo numero di **sensori**, la **MCU**, la **scheda di rete** verso la **rete di accesso** ai sensori, **batteria** di alimentazione. E' un nodo unico con tutto quello che serve per misurare e comunicare nella rete di sensori.
