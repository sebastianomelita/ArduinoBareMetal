...
- tradotto in una semantica custom che sia una versione più compatta di quella in uso nella rete di distribuzione in modo da adattarla a dispositivi di capacità trasmissiva molto limitata (poche decine di byte al sec)
