...
- i protocolli di livello fisico e data link (L1 e L2 OSI) sono generalmente diversi mentre quelli di livello di rete e trasporto (L3, L4OSI) sono esattamente gli stessi. Per effetto di ciò, ad esempio, una rete WiFi può comunicare direttamente con una rete Zigbee (o Thread) mediante gateaway router a cavallo tra le due.
