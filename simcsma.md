>[Torna all'indice](indexstatifiniti.md)>[Simulatore con await/async](simcsmaasync.md)
...
[Codice completo di tutte le stazioni collegate al BUS](csmatxrxproto.ino)
