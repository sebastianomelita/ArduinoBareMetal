...
Il **gateway All-In-One** potrebbe essere un dispositivo con **doppia interfaccia**, modem **UMTS** per l'accesso alla rete di distribuzione su **Internet**, **Zigbee** verso la **rete di sensori**. Può essere utile per realizzare un **coordinator Zigbee da campo** (saponetta zigbee) da adoperare in **contesti occasionali** (fiere, eventi sportivi, infrastrutture di emergenza, automezzi, mezzi mobili in genere).
