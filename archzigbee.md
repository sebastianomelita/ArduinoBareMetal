...
3. il JSON così costruito viene smistato sull'altra interfaccia del gateway, qualla IP dove viene imbustato come payload  del protocollo MQTT ed inviato fino al broker.
