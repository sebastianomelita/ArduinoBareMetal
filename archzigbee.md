...
Dagli **esempi** si vede bene che, nelle **reti Zigbee**, il **client MQTT** (con il ruolo di **publisher** o di **subscriber**) è sempre il **gateway** che è anche il coordinator della rete Zigbee. 
