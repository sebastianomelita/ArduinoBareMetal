...
<img src="img/ibeacon.png" alt="alt text" width="800">
...
Tutti i **dispositivi BLE** emettono beacon per cui il nome di beacon alla fine finisce per identificare anche un generico dispositivo BLE.
