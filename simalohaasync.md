>[Torna all'indice](indexstatifiniti.md)>[simulatore con protothread](simaloha.md)
...
- [Codice completo del ricevitore](ricevitore.ino)
- [Codice completo del trasmettitore](trasmettitore.ino)
