...
| [Sito archeologico con WiFi Mesh](/esempi/progetti/verifica_sistemi_reti_sito_archeologico.md) | WiFi Mesh, ACL, autenticazione 802.1X |
| [Smart Road Lorawan](/esempi/progetti/svolgimento_smart_road.md) | LPWA (LoRaWAN), VPN TAP, MQTT, continuità di servizio core, anello metropolitano, autenticazioni 802.1X e mTLS, subnetting IPv6 |
| [Albergo Domotizzato Zigbee](/esempi/progetti/albergo_soluzione.md) | Zigbee, ACL, cablaggio strutturato, MQTT |
