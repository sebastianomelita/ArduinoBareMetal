...
###  **Gestione di due nastri e tasto emergenza con interrupt (debouncing non bloccante con polling nella ISR)**

Per una discussione più completa sugli interrupt vedi [interrupt](interruptsbase.md).

Per una discussione più completa su pulsanti e interrupt vedi [interrupt pulsanti](intpulsante.md).

Versione con debouncing non blocccante basato su polling all'interno della ISR (interrupt Service Routine):
