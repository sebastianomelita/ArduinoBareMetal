...
Il **timeout** si controlla eseguendo il **polling** della funzione get() mediante un if valuta la condizione sulla get(). Un **polling** è l'interrogazione periodica di una **variabile** o di un **ingresso** per leggerne il **valore**. Se il valore è maggiore di un tempo massimo allora si considera avvenuto un **timeout** e si esegue il **blocco** di codice associato ad esso.
