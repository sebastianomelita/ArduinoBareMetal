...
Similmente, un **pacchetto privato** (la moto) vedrà solo **subnet private** (le piste sterrate) e l'interno di un furgone. Il **tunnel** è proprio il tragitto di transito che la moto percorre dentro il furgone, che si conclude all'arrivo su un nuovo sterrato (una subnet privata remota).
