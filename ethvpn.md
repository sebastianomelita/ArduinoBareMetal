...
E' come se si considerasse una **moto da cross** che va solo su **percorsi sterrati** e mai su **percorsi stradali** in città. Le **subnet private** sono gli sterrati, i percorsi stradali sono le **subnet pubbliche**.
...
Similmente, un **pacchetto privato** (la moto) vedrà solo **subnet private** (le piste sterrate) e il **tunnel** (l'interno di un furgone). Il **tunnel** è proprio il tragitto di transito che la moto percorre dentro il furgone, che si conclude all'arrivo su un nuovo sterrato (una subnet privata remota).
