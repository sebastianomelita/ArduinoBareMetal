...
Il **canale reale** è il **mwzzo trasmissivo** che unisce il **livello fisico** dei due interlocutori. Si sviluppa in **orizzontale** lungo il mezzo trasmissivo ma anche in **verticale** lungo le interfacce tra i vari strati, **a scendere** in trasmissione **a salire** in ricezione.
Mentre i messaggi dei vari livelli, **incapsulati** uno dentro l'altro, vengono trasmessi in un **blocco unico** lungo il **canale reale**, all'interno dei dispositivi a un capo e all'altro della connessione, sono **destrutturati** evidenziando, in un **canale virtuale** di un singolo livello, l'**abbinamento** tra il messaggio trasmesso da quel livello e il messaggio ricevuto, nello stesso livello, dal dispositivo all'altro capo. **In sostanza**, i messaggi trasmessi **separatamente** lungo i 7 **canali virtuali** diventano una **matrioska** di 7 messaggi **annidati** uno dentro l'altro che viaggia nel **canale reale**.
