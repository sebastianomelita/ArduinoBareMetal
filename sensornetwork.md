...
i canali virtuali si dividono in link **end to end**, perchè collegano livelli che sono presenti **soltanto** negli **host** cioè i **dispositivi terminali**, quelli su cui si **interfaccia l'utente**. Più in basso (i **primi 3** livelli). stanno i **link IS-IS** (collegamento tra  Intemediate systems), perchè collegano i **dispositivi di rete**, cioè quelli che creano la rete. Anche gli host posseggono questi livelli e pertanto sono, a tutti gli effetti, dispositivi di rete.
