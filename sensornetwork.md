...
- **commutazione** cioè lo **smistamento** dei dati tra le **dorsali** della rete LAN che, passando per certi switch e non per altri, realizza un **percorso** (path) fino ai router di confine della stessa (**gateway**).
