...
La **distribuzione uniforme** delle sottoportanti lungo tutta la banda fa si che, per effetto di una **interferenza distruttiva** o di un **fading** improvviso (attenuazione) in corrispondenza di una certa sottoportante, si perderanno le informazioni trasmesse su quella ma non le rimanenti trasmesse sulle altre sotoportanti. Questo perchè, in ricezione, le sottoportanti vengono demodulate separatamente e i bit ricevuti ricomposti in un unico flusso. E' il criterio dei **compartimenti stagni** di una nave (le **sottoportanti**) applicato al **canale** di una sorgente (l'intera **nave**). 
