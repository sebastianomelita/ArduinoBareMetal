...
- **creando un unica rete** utilizzando livelli di rete **compatibili** o **praticamente uguali** come sono **IPV6 e 6LowPan**. Lo stesso deve accadere per i livelli superiori eccetto l'ultimo: il **livello applicativo** deve rimanere esattamente **uguale** nelle due reti. Il **payload dell'applicazione** ora può viaggiare **direttamente** dal **client** al **sensore**, dove viene elaborato e utilizzato.
