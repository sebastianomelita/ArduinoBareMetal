...
La parte logica dei due stack sotto (LoraWan a sinistra e Zigbee a destra) potrebbe essere sostituita con IPV6 inserendo il rpotocollo 6LowPAN. la perte fisica di entrambi verrebe mantenuta perchè realizzata in HW. Nel caso di LoraWan l'implementazione HW è propietaria è fatta da una sola azienda e non è standardizzata industrialmente. Nel caso dello Zigbee la parte fisica è standardizzata con le sigla 802.15.4.
