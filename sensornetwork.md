...
**La seconda** è detta **multiplazione a divisione di frequenze ortogonali** o **OFDM**. **Gruppi diversi** hanno **sottoportanti** (dette ortogonali) **diverse**. E' la strategia generalmente adottata nei sistemi **WiFi** e sistemi di telefonia mobile **4G** e **5G**, caratterizzati da **alte potenze**, e **elevate bitrate** e **alto costo**.
