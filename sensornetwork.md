...
- **creando un unica rete** utilizzando livelli di rete **compatibili** o **praticamente uguali** come sono **IPV6 e 6LowPan**. Lo stesso deve accadere per i livelli superiori in particolare l'ultimo: il **livello applicativo**, il **payload dell'applicazione** deve poter viaggiare **direttamente** dal **client** al **sensore**, dove poi verrà elaborato e utilizzato.
