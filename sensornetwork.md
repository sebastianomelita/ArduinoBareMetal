...
Ci si potrebbe chiedere se è proprio necessario sapere i dettagli sui protocolli adoperati da questo o quel dispositivo. La risposta è legata al livello di strazione con cui la nostra applicazione vede la risorsa rete, con alcuni protocolli essa ha della rete e dei suoi protocolli una visione molto essenziale che si può ridurre al ventaglio di servizi di livello applicativo che lo stack di protocolli 
