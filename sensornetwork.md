...
Rappresentazione grafica del protocollo **ALOHA**. I riquadri chiari indicano le trame ricevute correttamente. I **riquadri ombreggiati** indicano le trame che hanno **colliso** e che verranno scartate perchè arrivate corrotte. Il **servizio radio** potrebbe prevedere la funzione di **conferma**, cioè tutti i messaggi debbano essere **confermati** presso il **nodo** che li **ha trasmessi** mediante la **ricezione** di un **messaggio di ack** inviato dal **ricevente** alla loro ricezione. Le **trame corrotte** non saranno confermate dal ricevente e, allo **scadere di un timeout**, verranno **ritrasmesse**.
