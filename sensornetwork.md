...
**La seconda** è detta **multiplazione a divisione di frequenze ortogonali** o **OFDM**. **Più canali** sono divisi in **sottoportanti diverse**. Ogni **sottoportante** può essere ulteriormente **partizionata nel tempo** tramite un **TDM** schedulato centralmente (nell'AP o nella BS) o a contesa che la assegna a **più sorgenti**. In pratica, il canale è partizionato sia **nel tempo** che **nella frequenza** secondo un **partizionamento** dinamico, **programmabile** per entrambi, da un **controllore centrale**. E' la strategia generalmente adottata nei sistemi **WiFi** e sistemi di telefonia mobile **4G** e **5G**, caratterizzati da **alte potenze**, e **elevate bitrate** e **alto costo**.
