...
- **creando un unica rete** con un **livello di rete** (il terzo OSI) **comune**. Attualmente ciò avviene solo grazie al **protocollo IP** (IPV4 o IPV6). I **livelli successivi** (dal trasposrto in poi) possono essere **uguali** nelle due reti. Se diversi devono essere simili e **traducibili** ma, in ogni caso, il **livello applicativo** deve rimanere **uguale** nelle due reti. 
