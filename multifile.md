...
#endif
```
Una **direttiva**, eseguita in **fase di compilazione** prima di includere il file header,  verifica se esso non sia già stato incluso in precedenza controllando una **costante flag** (bandierina) che viene definita al momento della prima inclusione.
