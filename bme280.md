...
Dal **punto di vista SW** seve **due librerie** da scaricare dentro la solita cartella **libraries**:
- **adafruit bme280**. Si scarica da https://github.com/adafruit/Adafruit_BME280_Library xxx da scompattare e rinominare semplicemente come yyy
- **Adafruit Unified Sensor**. Si scarica https://github.com/adafruit/Adafruit_Sensor come xxx da scompattare e rinominare semplicemente come yyy
