...
- avere un **indice** che identifica lo slot all'interno della trama che, essendo stato associato univocamente ad una sorgente, di rimando **identifica** anche il mittente quando il messaggio viene ricevuto all'**altro capo** del canale multiplato.
