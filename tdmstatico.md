...
- avere un **indice** che identifica lo slot all'interno della trama che, essendo associato univocamente ad una sorgente, di rimando **identifica** il mittente quando viene ricervuto il messaggio all'**altro capo** del canale multiplato.
