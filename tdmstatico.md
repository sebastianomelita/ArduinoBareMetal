...
I messaggi **arrivano** ad **ondate successive** assimilabilia a **round periodici**. Mentre si **trasmette** quella appena **ricevuta** si **riceve** la **successiva**. Il **ritardo** tra il momento della ricezione di un messaggio e quello della sua trasmissione è esattamente **T**.
