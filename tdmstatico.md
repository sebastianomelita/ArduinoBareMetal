...
- essere **sicronizzato** per tutte le sorgenti (sorgenti in fase). Cioè le sorgenti cominciano all'unisono la **ricezione** (caricamento della coda di ingresso) nello stesso momento e la terminano in un momento successivo ma sempre comune a tutte.
