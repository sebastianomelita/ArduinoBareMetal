...
6. [Schedulatore di compiti basato sui time tick](tasksched.md)
...
9. [Schedulatore di compiti basato su timers HW](timersched.md)
10. [Eventi periodici contemporanei: esempio di SOS + blink](sosblink.md)
11. [Eventi periodici consecutivi: esempio con i blink ](chainedevents.md)
