...
Il link equivale ad una **dorsale di trunk** tra due switch e aggrega su di se le **dorsali logiche** di tutte le VLAN di un tratto. Il CS L2 provvederà a fondere insieme le VLAN di ogni tratto, dove si allocheranno **tre subnet separate** (una per i sensori, una per le videocamere, una per le colonnine di ricarica).
