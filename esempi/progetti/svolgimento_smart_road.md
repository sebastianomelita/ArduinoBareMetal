...
- **Perché si usa**: Gestisce l'autenticazione a più fattori (notifiche push, SMS, app di autenticazione) in modo nativo e sicuro prima di darti l'accesso al jump host.
- **Esempio pratico**: Quando provi a connetterti al jump host, si apre una finestra browser che ti chiede email, password e l'approvazione sul telefono tramite MFA.
