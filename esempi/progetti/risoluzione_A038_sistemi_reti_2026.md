...
Lo **schema degli apparati attivi** ncomprende tutti gli scenari di integrazione possibili che sono compatibili con la traccia del compitò che è in realtà **piuttosto aperta** fermo restando la presenza di **sensori wireless e cablati**: **WiFi infrastruttura** come base cablata, poi **WiFi mesh** come base mesh per le zone senza cablaggio ma con sensori wiFi, reti **WSN** di diverse famiglie (Zigbee, lorawan o BLE), introdotte in cantiere a seconda del materiale disponibile e delle esigenze contingenti.  
