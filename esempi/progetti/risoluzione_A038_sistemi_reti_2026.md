...
A sinistra il mondo dei certificati X.509, a destra quello della chiave pre-condivisa per i dispositivi vincolati. Le due figure risolvono lo stesso problema da due approcci opposti (dettagli in [autenticazione collegamento](/approfondimenti/autenticazione_collegamento_guida.md):
