...
Il **benefici** di un recerse proxy sono essenzialmente:
- **condivisione** di una **stessa porta** (TCP o UDP) per il **partizionamento verticale** di uno **stesso servizio logico** su **server fisici diversi** che lo gestiscono diversamente per scopi diversi
