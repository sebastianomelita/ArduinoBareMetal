...
- **condivisione** di una **stessa porta** (TCP o UDP) per ottnere il **partizionamento verticale** di uno **stesso servizio logico** su **server fisici diversi** che lo gestiscono diversamente per scopi diversi
