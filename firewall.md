...
- **condivisione** di una **stessa porta** (TCP o UDP) per il **partizionamento verticale** di uno **stesso servizio logico** su **molti server** fisici che lo gestiscono diversamente per scopi diversi
