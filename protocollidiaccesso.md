...
- Altrimenti la stazione **arresta** la trasmissione corrente e **trasmette** invece una particolare sequenza, detta **sequenza di jamming**, che avvisa chi non trasmette ancora che c'è stata una collisione nel caso che, essendo questa avvenuta tra stazioni troppo vicine, non possa essere rilevata da quelle più lontane (due onde sovrapposte brevi dopo un certo tempo si separano).
