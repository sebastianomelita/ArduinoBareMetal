...
- **Altrimenti** la stazione **arresta** la trasmissione corrente e **trasmette** invece una particolare sequenza di **32 byte**, detta **sequenza di jamming**, che avvisa della collisione chi ancora **non trasmette** e che ha una **durata** tale da rendere **sempre possibile** la rilevazione della collisione da parte di coloro che **stanno già trasmettendo** anche se si tratta di stazioni poste a grande distanza dal punto della collisione. Infatti, nel caso in cui la collisione, avvenga tra stazioni **molto vicine**, questa potrebbe essere rilevata (e quindi interrotta) troppo presto per consentire la sua rilevazione a grandi distanze nel BUS, dato che due onde sovrapposte brevi e viaggianti in senso opposto, dopo un certo tempo, si separano (vedi Fig.7).
