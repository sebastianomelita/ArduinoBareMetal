...
Nel caso del WiFi in figura, è illustrato un backoff **con prenotazione** che ha la proprietà di non azzerare, sprecandolo, il tempo di attesa **già trascorso** da una stazione sul proprio backoff. Nel momento in cui il canale **ritorna libero**, la stazione che aveva "congelato" il backoff quando lo aveva sentito occupato, ricomincia il **conteggio iniziale** dal tempo già consumato, senza ricalcolarlo daccapo. E' una maniera per non perdere la **priorità acquisita** ricalcolando il backoff da zero. E' una **ottimizzazione** per garantire una maggiore **equità (fairness)** nell'accesso alla risorsa canale che non sempre è implementata in protocolli CSMA/CA diversi dal WiFi.
