...
Quelli **statistici** o **a contesa** realizzano una competizione per l'accesso al mezzo che deve essere regolata semplucemente osservando il canale in maniera indipendente senza coordinamento alcuno. Questa categoria di protocolli limitano statisticamente il problema delle collisioni ma non lo annullano completamente, per cui le collisioni necessitano ancora di essere rilevate dalle singole stazioni.
