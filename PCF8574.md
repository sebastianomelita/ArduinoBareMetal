...
Si può stampare su due righe impostando prima lcd.setCursor(0, 0), scrivere sulla prima riga e dopo impostando lcd.setCursor(0,1) scrivere sulla seconda. Si può utilizzare una schedulazione del tempo con delay() o millis() per realizzare una scrittura di contenuti lunghi su più pagine consecutive. Il contenuto corrente di una pagina si imposta con lcd.print("Hello, World!"), mentre quello vecchio si cancella con clear().
