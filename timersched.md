...
-  un'**astrazione logica** del timer HW che si possa **instanziare molte volte** ogni volta associandola ad una **propria callback**. I timer HW sottostanti rimangono sempre solamente 4.
