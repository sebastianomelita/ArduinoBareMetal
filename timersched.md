...
-  un'**astrazione logica** del timer HW che si può **instanziare molte volte** associandola alla propria callback. I timer HW sottostanti rimangono sempre solamente 4.
