...
<img src="img/broadcastl3.png" alt="alt text" width="600"> 
...
- Di fatto, si realizza, grazie al TDM estremamente veloce dello switch in L2, un SDM virtuale che, apparentemente, realizza in L3 una rete magliata di router.
