...
- ha i suoi confini sui link fisici che essa realizza su dei **router** che sono dei limiti invalicabili all'inoltro diretto dei messaggi IP tra gli host e vengono detti, per l'appunto, **router di confine**. 
