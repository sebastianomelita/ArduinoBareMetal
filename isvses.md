...
Quanto visto per gli Switch 8e quindi i bridge) vale anche per gli Hub (sia wireless che cablati), per cui un collegamento a Bus qualsiasi con un mezzo broadcast (filo o onde radio) ha la proprietò di essere visto dai router come un **collegamento virtuale diretto** tra essi e **ciascun Host** collegato al **mezzo a Bus**. La stessa proprietà, su un mezzo a Bus, ce l'hanno i **collegamenti reciproci** tra gli host.  
