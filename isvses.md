...
I dispositivi di livello 1, si limitano a **copiare bit** da una porta di **ingresso** per poi inoltrare in **uscita** una loro **replica** su ogni porta che però **non sia** anche la porta di **origine** dei bit. 
