...
I dispositivi di livello 1, si limitano a **copiare bit** da una porta di **ingresso** per inoltrare una loro **replica** su ciascuna altra porte che **non sia** la porta di **provenienza**. Sono adoperati in reti geografiche commutate (WAN)  e nelle reti locali (LAN). Possono essere:
