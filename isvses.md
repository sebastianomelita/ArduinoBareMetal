...
- un host della LAN, che sia sorgente di pacchetti IP destinati ad un host esterno (ad esempio, Internet), può sempre **inoltrare** i propri pacchetti al **router di confine** da dove verranno rilanciati da un router all'altro fino alla **destinazione**, che starà, presumibilmente, in un'**altra LAN**.
