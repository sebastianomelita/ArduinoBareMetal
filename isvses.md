...
I dispositivi di **livello 3** sono un **barriera** invalicabile per la propagazione delle **trame** provenienti dai dispositivi di livello 2 perchè questi riconoscono e smistano solamente **PDU di livello 3**. Pertanto, le trame di livello 2, devono essere **sbustate** , cioè **aperte**, per recuperare il payload in esse contenuto ovvero i pacchetti i pacchetti IP di livello 3 che invece possono passare attraverso il router così come sono, **senza modifica alcuna**. 
