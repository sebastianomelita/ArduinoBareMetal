...
- Se due device trasmettono nello stesso istante sulla stessa frequenza e stesso SF, c'è collisione e (probabilmente) il gateway perde entrambi (vedi [Ortogonalità LoRa](approfondimenti/ortogonalita-lora.md) e [Dettaglio tecnologie di accesso al mezzo radio](accessoradio.md)).
