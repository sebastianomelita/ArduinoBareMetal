...
Per assicurarsi che i fronti siano sicuramente presenti in numero **sufficiente** allo scopo, solitamente si fa precedere il messaggio vero e proprio da un **preambolo di sincronizzazione**. Il preambolo è una sequanza speciale caratterizzata dall'avere una successione ininterrotta di fronti alternati verso l'alto e verso il basso che permette una sicura ricalibrazione del clock in ricezione.
