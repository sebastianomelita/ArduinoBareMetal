...
| 3       | Rete                  | **Indirizzamento**, cioè individuazione del luogo fisico in cui si trova l'host destinatario, **sceglie** il percorso migliore per raggiungerla (**routing**), esecuzione dell'**inoltro fisico** dei pacchetti da una porta di ingresso a quella di uscita che sta nel percorso scelto (**forwarding**), per ogni router incontrato lungo il percorso.  |                                                                         |
