...
- **livello 2**, dove potrebbe esserci una **intera LAN**, realizzata con SW collegati **ad albero** che viene astratta in tanti link diretti tra host, uno per ogni possibile collegamento reciproco tra loro (**maglia completa** come servizio a livello 3). 
