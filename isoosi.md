...
| 3       | Rete                  | Fornisce al livello 4 un canale dedicato a 2 2 host fisicamente lontani (remoti), a basso BER e steso tra i due endpoint scegliendo autonomamente il percorso dei pacchetti |      Realizza la localizzazione fisica del destinatario e il calcolo del percorso per raggiungerlo attraverso i nodi|                                                                         |
