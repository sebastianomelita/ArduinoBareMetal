...
La **ricostruzione sottostante** mira a rappresentare una rete OSI come una **infrastruttura** volta a realizzare la comunicazione tra due **processi remoti** in particolare, tra i tanti che girano in due **host remoti**, a loro volta scelti tra i tanti collegati ad Internet. Un processo è individuabile univocamente nel mondo tramite la **coppia** (indirizzo **IP**, numero di **porta**) detta talvolta **socket**.
