...
2. al livello generico N lo **schema** della rete pottrebbe apparire **semplificato**, mentre la sua **struttura** reale potrebbe essere più **articolata**, anche quando è stata **riassunta** in un **unico link**. In particolare, ciò che al **livello N** generico appare come un **collegamento virtuale diretto** tra due host potrebbe essere, ai livelli sottostanti, fisicamente **spezzato** in più collegamenti tra **nodi intermedi** di **transito**.
