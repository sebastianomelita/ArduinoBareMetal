...
Si noti il ruolo della segmentazione ai livelli 2 e 4 che, frammentando lunghi stream di dati in unità informative più piccole, permette la multiplazione del canale, cioè la condivisione dello stesso tra pacchetti di sorgenti diverse di livello superiore aventi indirizzo diverso:
