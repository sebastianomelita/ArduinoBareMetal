...
La realizzazione tecnologica di una **WAN mondiale** non è stata inizialmente ottenuta con un'**unica rete WAN** ma piuttosto, grazie ad una soluzione tecnica di compromesso, con una **federazione** di reti **WAN** e **LAN** eterogenee, la **Internet** propriamente detta.  Internet, nata nel ristretto ambiente della ricerca negli anni 70', ha poi riscosso il successo commerciale a cui siamo abituati solo all'indomani dell'invenzione del **WWW** (World Wide Web), avvenuta nel 1990. 
