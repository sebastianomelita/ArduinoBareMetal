...
| Livello | Nome                  | Astrazione fornita                                                                                                      | Funzioni svolte (riassunto incompleto)                        |
|---------|-----------------------|-------------------------------------------------------------------------------------------------------------------------|-----------------------------|
| 7       | Applicazione          | fornisce al livello 5 un canale dedicato a 2 host e a 2 processi, a basso BER, FIFO e immune dalla perdita di pacchetti per congestione e sovraccarico del ricevente e immune dalla perdita di pacchetti per macato accordo sulle fasi della trasmissione e con un formato comune del payload                                                                                                                 | non deve fare nulla |
| 6       | Presentazione         | fornisce al livello 6 un canale dedicato a 2 host e a 2 processi, a basso BER, FIFO e immune dalla perdita di pacchetti per congestione e sovraccarico del ricevente e immune dalla perdita di pacchetti per macato accordo sulle fasi della trasmissione e con un formato comune del payload                                                                                                                 | si è realizzata una negoziazione dei formati del payload tra quelli disponibili ad entrambi gli interlocutori| 
| 5       | Sessione              | fornisce al livello 5 un canale dedicato a 2 host e a 2 processi, a basso BER, FIFO e immune dalla perdita di pacchetti per congestione e sovraccarico del ricevente e immune dalla perdita di pacchetti per macato accordo sulle fasi della trasmissione | la trasmissione vienne suddivisa in fasi su cui esiste un accordo su quanto durino e come si raggiungano |                                                                                                            |
| 4       | Trasporto             | fornisce al livello 5 un canale dedicato a 2 host e a 2 processi, a basso BER, FIFO e immune dalla perdita di pacchetti per congestione e sovraccarico del ricevente | esegue la multiplazione di più processi su una stessa macchina, abbassa ulteriormente la BER, limita la velocità del mittente a beneficio del rcevitore e della rete intera |                                                                                                          |
| 3       | Rete                  | fornisce al livello 4 un canale dedicato a 2 host, a basso BER e steso tra i due endpoint scegliendo autonomamente il percorso dei pacchetti |      realizza la localizzazione fisica del destinatario e il calcolo del percorso per raggiungerlo attraverso i nodi|                                                                         |
| 2       | Collegamento dati     | fornisce al livello 3 un canale dedicato a 2 host e con bassa BER e immune dal sovraccarico del ricevente  | realizza una condivisione del canale tra più host e una rilevazione e correzione di errore tramite CRC e una limitazione di velocità del trasmittente |
| 1       | Fisico                | fornisce al livello 2 un canale di bit.                                | esegue una codifica/decodifica dei bit in segnali elettrici|
