...
- in un router (IS), esiste uno **stack separato** per **ogni porta**, detta anche interfaccia o NIC (Network Interface Card), di cui esso è dotato, per cui pacchetti vengono:
     - **sbustati** sulla porta di **ingresso**, dove viaggiano in **verticale ascendente** dal livello 1 fino al livello 3, dove vengono recuperati i **pacchetti IP**
     ...
     - **imbustati** sulla porta di **uscita**, dove viaggiano in **verticale discendente** dal livello 3 fino al livello 1, dove vengono spediti **bit**
