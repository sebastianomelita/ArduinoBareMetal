...
Per contro, i canali realizzati con **multiplazione statica** mantengono ancora un'**affidabilità** e precisione temporale nella consegna (**jitter**) tutt'ora inegualiate dalle reti a pacchetto. Nonostante ciò, la **multiplazione statica** è oramai preferibile solo in applicazioni **di nicchia** in cui il **traffico prenotato** è sempre **costante** e mai **sprecato**, come l'interrogazione periodica (**polling**) dei sensori nel mondo IoT, come quella effettuata, ad esempio, all'interno della zona CFP delle **supertrame** wireless.
