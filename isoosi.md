...
La realizzazione tecnologica di questo obiettivo non è stata inizialmente ottenuta con un'**unica rete WAN** ma piuttosto, grazie ad una soluzione di compromesso, con una **federazione** di reti **WAN** e **LAN** eterogenee, la **Internet** propriamente detta, che ha poi riscosso immediato successo commerciale all'indomani dell'invenzione del **WWW** (World Wide Web), avvenuta nel 1990. 
