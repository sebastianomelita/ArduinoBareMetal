...
| 3       | Rete                  | fornisce al livello 4 un canale dedicato a 2 vicini fisicamente, a basso BER e steso tra i due endpoint scegliendo autonomamente il percorso dei pacchetti |      realizza la localizzazione fisica del destinatario e il calcolo del percorso per raggiungerlo attraverso i nodi|                                                                         |
| 2       | Collegamento dati     | fornisce al livello 3 un canale dedicato a 2 dispositivi vicini fisicamente e con bassa BER e immune dal sovraccarico del ricevente  | realizza una condivisione del canale tra più host e una rilevazione e correzione di errore tramite CRC e una limitazione di velocità del trasmittente |
