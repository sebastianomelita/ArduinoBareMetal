...
| 2       | Collegamento dati     | Fornisce al livello 3 un canale **dedicato** a 2 **IS** fisicamente vicini e con bassa BER e immune dal sovraccarico del ricevente  | Realizza, tramite multiplazione dinamica TDM, una condivisione del canale tra più nodi e una rilevazione e correzione di errore tramite CRC e una limitazione di velocità del trasmittente |
