...
In sostanza, una **rete proprietaria**, con propri schemi di indirizzamento (spesso non IP o con IP privati), viene utilizzata per creare un **link logico**, una sorta di **cavo di dorsale virtuale**, tra i router IP di una **Internet mondiale** che utilizza indirizzi **IP pubblici**. 
