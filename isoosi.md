...
- **livello 4**, dove una **intera rete IP**, composta da **link tra router** collegati, in genere, a maglia, viene astratta in tanti **link tra host** diretti, uno per ogni possibile collegamento reciproco tra loro (**maglia completa** come servizio a livello 4)
