...
Un **canale virtuale** è un **canale logico** che **emula** un **collegamento diretto** tra **entità pari** dando l'impressione a queste entità che nel collegamento tra di esse siano scambiate **solamente** le **PDU** di quel livello, per di più seguendo soltanto le regole del **protocollo** che in quel livello è in uso. I **canali virtuali** vengono **creati** grazie alla tecnica dell'**imbustamento multiplo** e rappresentano il **punto di vista** che un **generico livello** ha dell'unico canale effettivamente esistente, cioè il **canale reale** di livello 1 (fisico). 
