...
Al fine di scegliere l'**approccio** per implementare una macchina a stati finiti (FSM), possiamo **valutare** il diagramma degli stati che la rappresenta in base ad alcuni **criteri**:
