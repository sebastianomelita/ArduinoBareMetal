...
- una **asincrona**, non governata dal sistema, ma da un segnale **di ingresso** proveniente dall'**esterno**, per la determinazione istantaea (o quasi) del fronte di salita per poter elaborare la risposta il più vicino possibile all'evento che la ha causata.
