...
Per una discussione generale sugli interrupt si rimanda a ![interrupt]([transizioni.png](https://github.com/sebastianomelita/ArduinoBareMetal/blob/master/indexinterrupts.md)).
