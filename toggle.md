...
Pur utilizzando gli interrupt, l'efficacia del codice precedente in termini di velocità e responsività è limitata dalla **componente nel loop()** del meccanismo che è sensibile a ritardi di esecuzione che in esso possono essere introdotti da eventuali istruzioni delay() o a blocchi di istruzioni troppo lente al suo interno. L'efficacia di questa realizzazione è quindi vanificata dai limiti intrinseci della **schedulazione periodica** effettuata nel loop().
