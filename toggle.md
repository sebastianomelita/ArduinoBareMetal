...
Pulsante toggle che realizza blink e  antirimbalzo realizzato con una **schedulazione sequenziale con i ritardi** emulati tramite **protothreads** (per una spiegazione dettagliata dei protothread si rimanda a https://github.com/sebastianomelita/ArduinoBareMetal/blob/master/protothreadsched.md):
```C++
#define LC_INIT(lc)
