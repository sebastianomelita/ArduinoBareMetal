...
- Se si usano i **protothread** o i **thread** viene mantenuta la proprietà di intrinseca **semplicità** della programmazione **lineare** basata su attese di tempo (**delay**) o attese su ingressi (**waitUntil**) garantendo la sostanziale **responsività** degli ingressi di ogni task dato che ognuno mantiene periodicamente il controllo della CPU grazie al **prerilascio** forzato della stessa dopo un certo **quanto** di tempo. 
