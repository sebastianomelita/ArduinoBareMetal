...
Pur utilizzando gli interrupt, l'efficacia del codice precedente in termini di velocità e responsività è limitata dalla **componente nel loop()** del meccanismo che è sensibile a ritardi di esecuzione dello stesso potenzialmente dovuti a eventuali istruzioni delay() in esso presenti o a blocchi di istruzioni troppo lente. L'efficacia di questa realizzazione è quindi vanificata dai limiti intrinseci della **schedulazione periodica**.
