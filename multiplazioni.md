...
E’ possibile **allocare** una comunicazione su **una porzione** della **grandezza fisica** a cui essa è **associata**. La **grandezza fisica** è una **proprietà** fisica del **segnale** che **trasporta i bit** della comunicazione mediante tecniche di **modulazione**.
