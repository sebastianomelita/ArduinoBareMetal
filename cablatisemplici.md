...
La privatezza dei dati, in assenza di crittografia, è limitata perchè i dati inviati da una stazione sono inviati fisicamente a tutte le altre stazioni. Le stazioni però sono normalmente istruite a filtrare le counicazioni a loro non destinate ma nonostante ciò il dato però è comunque a loro visibile e un attacco di **sniffing** da parte di una stazione intrusa che non segue le regole è sempre possibile. 
