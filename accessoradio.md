...
Di seguito sono elencati **tutti i sottocanali allocabili**. Sono possibili anche **combinazioni di ampiezza diversa**. L'unico **vincolo** è che la **somma complessiva delle sottoportanti** allocate nei vari sottocanali in un certo slot temprale non superi mai il **numero complessivo** delle sottoportanti (256 per il WiFi 6).
