...
Molte tecnologie di accesso al **canale radio** mirano a trasferire più segnali in banda base, provenienti da sorgenti di informnazione diverse, sullo stesso mezzo radio e nello stesso tempo ma su frequenza diverse, utilizzando una tecnica FDM. Queste tecniche presuppongono la **traslazione del segnale** da trasmettere dalla sua frequenza originale (detta **banda base**), dove viene **generato**, a quella di **trasmissione** (detta banda **traslata**), dove viene **trasmesso**. 
