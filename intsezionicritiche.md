...
-	**mantenendo le interruzioni**, facendo in modo che:
    -	**all’inizio del codice** del loop, si **copi** la variabile condivisa su una **variabile locale** mediante un’operazione assegnamento che dovrebbe avvenire all’interno di una **corsa critica** per proteggerla da eventuali interruzioni.
