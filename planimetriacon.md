...
- se ci sono **più stanze uguali**, dato che la numerazione è gerarchica, basta modificare solo la numerazione dell'armadio di piano che la serve. La numerazione dei TO deve cominciare con un punto per far capire che bisogna completarla col prefisso degli armadi
