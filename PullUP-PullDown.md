...
- Il terminale del pulsante che, a pulsante aperto, non è collegato alla resistenza (a sinistra della resistenza nel disegno) va collegato all'alimentazione positiva in caso di **pull down** o all'alimentazione negativa in caso di **pull up**. Questo perchè, a pulsante chiuso, la funzione di **pull** della porta digitale, alla **tensione cointraria** a quella di riposo, è svolta sempre **dal pulsante** proprio tramite un filo.
