...
- **Ruolo del pulsante** è quello di cortocircuitare, cioè polarizzare, l’ingresso del microcontrollore a potenziale GND nel caso della polarizzazione **pullup**, o a potenziale **Vcc** nel caso di quella **pulldown** (ai suoi capi la legge di Ohm vale Vfilo = R\*I = 0\*I =0). L’effetto è evidentemente quello di **invertire** lo stato logico di default (determinato, a pulsante aperto, dalla resistenza).
