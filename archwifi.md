...
- Se si definisce un'**unica subnet** per **tutti** i router, chiaramente si implementa un **unico gruppo** su tutta la rete mesh, valido per tutti i router con un unico ssid.
