...
Inoltre, nelle reti mesh WiFi, il **routing** è generalmente **automatico**, utilizzando protocolli di **routing dinamico** che consentono ai nodi di scoprire e mantenere le rotte in modo dinamico, adattandosi ai cambiamenti nella topologia della rete garantendo la loro **resilienza**. Sono in genere di **due tipi** differenti:
