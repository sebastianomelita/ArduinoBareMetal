...
Inoltre, nelle reti mesh WiFi, il **routing** è generalmente **automatico**, utilizzando protocolli di **routing dinamico**, questi consentono ai nodi di scoprire e mantenere le rotte in modo dinamico, adattandosi ai cambiamenti nella topologia della rete garantendo  **resilienza** (in caso di guasti o interferenze) e **scalabilità** (in caso dell'aggiunta di nuovi nodi). Sono in genere di **due tipi** differenti:
