...
In tabella un elenco parziale con le principali **limitazioni** che riguardano principalmente **potenza**, **duty cycle**, **EIRP**, **ERP** e il **tipo di accesso** (ALOHA, LBT o AFA). Vedi [Banda ISM 800 MHz](master/ism.md) per dettagli.
...
- **Wi-Fi 6/6E**: Preferire dispositivi che supportano Wi-Fi 6 o 6E per beneficiare delle tecnologie più recenti, come OFDMA, MU-MIMO, e canali a 160 MHz. Vedi [Modulazioni radio](accessoradio.md#ofdm).
