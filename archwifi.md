...
- definizione delle tecniche di **autenticazione** dei servizi (openid, psw, ecc).
...
<img src="img/wifi_direct.png" alt="alt text" width="800">
...
- la possibilità di poter considerare le LAN ai due capi del bridge come **una sola LAN** su cui allocare per i PC gli indirizzi di una **stessa subnet IP**. 
...
In genere, gli host sulla LAN del client utilizzano il server DHCP del dispositivo client, poiché di fatto essi stanno su una rete sconosciuta per il lato AP. 
