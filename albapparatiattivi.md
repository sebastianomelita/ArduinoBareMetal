...
- identificare le **subnet**:
    ...
    - tutti i **link fisici indiretti** tra **più router**, con in mezzo uno o più **switch** di transito, si contano **una sola volta**
...
<img src="img/subnets.png" alt="alt text" width="700">
