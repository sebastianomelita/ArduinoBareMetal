...
I **router** sono i dispositivi che **allocano nello spazio** le subnet assegnandole a **gruppi di host**. Le **interfacce** di un **router** che possono **generare subnet** sono tutte quelle L3 o superiori, sia fisiche che virtuali e tipicamente sono:
