...
Le **subnet** sono **contenitori di indirizzi IP** derivati da altri contenitori di indirizzi IP partendo dal **partizionamento** della **parte di host** dell'indirizzo, **associando** il **prefisso** di subnet a **gruppi** di host.
